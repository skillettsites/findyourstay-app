...
export const guide: Guide = {
  slug: "airbnb-vs-booking-com-for-hosts",
  ...
  keywords: [
    ...
    "booking.com vs airbnb host",
    "which is better airbnb or booking.com",
    "airbnb or booking.com for hosts",
  ],
  date: "2026-06-30",
  updated: "2026-06-30",
  readMins: 7,
  ...
  faqs: [
    {
      q: "Is Airbnb or Booking.com cheaper for hosts?",
      a: "Airbnb charges hosts around 15.5% per booking. Booking.com starts at roughly 15% but can reach 25% depending on your market and tier, with additional reductions if you participate in Genius discounts. In most scenarios the two platforms are similar on base commission, though Booking.com's optional programmes can push your effective rate higher. Both are significantly more expensive than taking direct bookings, which cost only card processing fees of around 1.5% plus 20p per transaction.",
    },
    {
      q: "When does Airbnb pay hosts?",
      a: "Airbnb typically releases payment to hosts approximately 24 hours after the guest checks in. The funds then take a further few days to clear depending on your bank and payment method. This means for a standard two-night weekend stay arriving Friday, you can usually expect the money in your account early the following week.",
    },
    {
      q: "Can I use both Airbnb and Booking.com at the same time?",
      a: "Yes, most independent hosts list on both platforms and manage availability through a shared calendar or channel manager to avoid double bookings. Running both gives you access to different guest demographics and reduces reliance on any single platform. Many hosts then add a direct-booking website as a third channel for returning guests who prefer to book without paying a platform service fee.",
    },
    {
      q: "What is a direct-booking website and how does it work?",
      a: "A direct-booking website is your own property site where guests can check availability and pay you without going through Airbnb or Booking.com. Payments go straight to your bank account via a payment processor such as Stripe. You pay no commission to the platform; only card processing fees apply. FindYourStay builds and hosts these websites for independent hosts from £149 per year, on your own domain, with no booking commission ever charged.",
    },
  ],
  related: [
    "airbnb-host-fees-explained",
    "how-much-commission-booking-com",
